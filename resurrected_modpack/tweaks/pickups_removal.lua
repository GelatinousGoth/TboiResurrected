...
local function InitRemovedPickupsList()
	...
	blockedCards_FF = {
		...
		FiendFolio.ITEM.CARD.MISPRINTED_THREE_OF_DIAMONDS,
		FiendFolio.ITEM.CARD.THIRTEEN_OF_STARS,
		FiendFolio.ITEM.CARD.PLAGUE_OF_DECAY,
		FiendFolio.ITEM.CARD.DEFUSE,
		FiendFolio.ITEM.CARD.NEKO_NYAN_QUIZ_CARD,
		FiendFolio.ITEM.CARD.FRIENDLY_FIRE,
		FiendFolio.ITEM.CARD.RESCUE_CAT,
		FiendFolio.ITEM.CARD.EYE_OF_TRUTH,
		FiendFolio.ITEM.CARD.DESTINY_BOARD,
		FiendFolio.ITEM.CARD.MISPRINTED_GISH,
		FiendFolio.ITEM.CARD.DANCE_OF_USURPATION,
		FiendFolio.ITEM.CARD.DRACONIC_FERVOR,
		FiendFolio.ITEM.CARD.ELF_SONG,
		FiendFolio.ITEM.CARD.BLASPHEMY,
		FiendFolio.ITEM.CARD.OJ_STRONGER,
		FiendFolio.ITEM.CARD.OJ_HINDENPEATER,
		FiendFolio.ITEM.CARD.OJ_SEAGULLS,
		FiendFolio.ITEM.CARD.OJ_ENCHANTMENT,
		FiendFolio.ITEM.CARD.MISPRINTED_KING_OF_PENTACLES,
		...
		FiendFolio.ITEM.CARD.PINK_COW,
		FiendFolio.ITEM.CARD.COMICAL_ROUND_GLASSES,
		FiendFolio.ITEM.CARD.CHRISTMAS_CRACKER,
		FiendFolio.ITEM.CARD.HAPPY_SQUIRREL,
