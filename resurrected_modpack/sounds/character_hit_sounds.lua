...
CHS = TR_Manager:RegisterMod("Character Hit Sounds", 1)
...
CHS.PLAYER_NAME = require("resurrected_modpack.sounds.character_hit_sounds.player_name")
CHS.SOUND = require("resurrected_modpack.sounds.character_hit_sounds.sound")
CHS.DEFAULT_SOUND = require("resurrected_modpack.sounds.character_hit_sounds.default_sound")
CHS.DEFAULT_DATA = require("resurrected_modpack.sounds.character_hit_sounds.default_data")
CHS.MCM_STRINGS = require("resurrected_modpack.sounds.character_hit_sounds.mcm_strings")
