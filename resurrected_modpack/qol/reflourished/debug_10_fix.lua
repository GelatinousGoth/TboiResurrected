local function Debug10FixEnabler()
...
function Debug10Fix:OnNpcUpdate(npc)
...
mod:AddCallback(ModCallbacks.MC_NPC_UPDATE, Debug10Fix.OnNpcUpdate, EntityType.ENTITY_THE_LAMB)
mod:AddCallback(ModCallbacks.MC_NPC_UPDATE, Debug10Fix.OnNpcUpdate, EntityType.ENTITY_DELIRIUM)
mod:AddCallback(ModCallbacks.MC_NPC_UPDATE, Debug10Fix.OnNpcUpdate, EntityType.ENTITY_ROTGUT)
mod:AddCallback(ModCallbacks.MC_NPC_UPDATE, Debug10Fix.OnNpcUpdate, EntityType.ENTITY_MOTHER)
mod:AddCallback(ModCallbacks.MC_NPC_UPDATE, Debug10Fix.OnNpcUpdate, EntityType.ENTITY_DOGMA)

end
return Debug10FixEnabler