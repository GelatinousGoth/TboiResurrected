...
local particleSpawnRoutines = {
    [TheGauntlet.Items.Demeter.Season.WINTER] = include("resurrected_modpack.rooms.gauntlet.items.demeter.visuals.snowflake_spawn"),
    [TheGauntlet.Items.Demeter.Season.SPRING] = include("resurrected_modpack.rooms.gauntlet.items.demeter.visuals.falling_leaf_spawn"),
    [TheGauntlet.Items.Demeter.Season.AUTUMN] = include("resurrected_modpack.rooms.gauntlet.items.demeter.visuals.falling_leaf_spawn"),
}

local particleUpdateRoutines = {
    [TheGauntlet.Items.Demeter.Season.WINTER] = include("resurrected_modpack.rooms.gauntlet.items.demeter.visuals.snowflake_update"),
    [TheGauntlet.Items.Demeter.Season.SPRING] = include("resurrected_modpack.rooms.gauntlet.items.demeter.visuals.falling_leaf_update"),
    [TheGauntlet.Items.Demeter.Season.AUTUMN] = include("resurrected_modpack.rooms.gauntlet.items.demeter.visuals.falling_leaf_update"),
}

local particleRenderRoutines = {
    [TheGauntlet.Items.Demeter.Season.WINTER] = include("resurrected_modpack.rooms.gauntlet.items.demeter.visuals.snowflake_render"),
    [TheGauntlet.Items.Demeter.Season.SPRING] = include("resurrected_modpack.rooms.gauntlet.items.demeter.visuals.falling_leaf_render"),
    [TheGauntlet.Items.Demeter.Season.AUTUMN] = include("resurrected_modpack.rooms.gauntlet.items.demeter.visuals.falling_leaf_render"),
}
