...
local saveManager = require("resurrected_modpack.graphics.unique_progress_bas_icon.save_manager")
saveManager.Init(UniqueProgressBarIcon)
UniqueProgressBarIcon.SaveManager = saveManager
require("resurrected_modpack.graphics.unique_progress_bas_icon.imGui")
local api = include("resurrected_modpack.graphics.unique_progress_bas_icon.api")
