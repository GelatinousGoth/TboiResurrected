...
local mod = TR_Manager:RegisterMod("Bullet Trail Mod", 1)
local json = include("resurrected_modpack.graphics.bullet_trails_scripts.json")
...
local DSSInitializerFunction = include("resurrected_modpack.graphics.bullet_trails_scripts.dssmenucore")
